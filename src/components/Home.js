          ...
          {owner ? (
            ...
            <div>
              {account === inspector ? (
                ...
                <button className="home__buy" onClick={inspectionHandler} disabled = {hasInspected}>Pass Inspection</button>
              ) : account === lender ? (
                <button className="home__buy" onClick={lendHandler} disabled = {hasLended}>Lend Balance Money</button>
              ) : account === seller ? (
                <button className="home__buy" onClick={sellHandler} disabled = {hasSold}>Sell Property</button>
              ) : (
                <button className="home__buy" onClick={buyHandler} disabled = {hasBought}>Buy Property</button>
              )}
